...
func Load() Config {
	...
	config.ProjectName = cast.ToString(getOrReturnDefaultValue("PROJECT_NAME", "bootcamp"))
	...
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "bootcamp"))
